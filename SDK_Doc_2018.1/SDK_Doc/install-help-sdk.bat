...
powershell (New-Object -ComObject Wscript.Shell).Popup("""Click OK to copy the help files to %UserProfile%\.Xilinx\SDx\2018.1\helpdocs\sdk""",0,"""Accessing Xilinx SDK Help Content""",0x0)
XCOPY /E/Y *.* "%UserProfile%\.Xilinx\SDx\2018.1\helpdocs\sdk"
cd "%UserProfile%\.Xilinx\SDx\2018.1\helpdocs\sdk"
DEL *.bat
